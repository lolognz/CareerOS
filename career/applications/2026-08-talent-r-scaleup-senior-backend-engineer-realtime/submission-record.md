...
- Email facilitado al recruiter: `lolognz@gmail.com`.
- El recruiter aclaró que “perfil 360” cubre código, testing local, review, CI/CD, staging, producción y monitorización/debug en servidor, con Linux y algo de DevOps propio al no existir equipo dedicado.
- El candidato explicó transparentemente su ciclo completo de trabajo, la presencia histórica de equipos DevOps, sus permisos limitados en producción y su exposición parcial a Docker, Kubernetes, cloud, Linux y monitorización.
- El recruiter valoró la transparencia, reconoció mentalidad y hábitos 360, calificó DevOps como gap derivado de los entornos previos y dijo que no era descarte automático.
- El recruiter solicitó CV y email y aceptó realizar entrevista.
- El 2026-08-04 se envió por LinkedIn a Eduardo Ruiz Romero, IT Consultant 360º @Talent-R, el CV adaptado para la oportunidad Senior Backend Engineer real-time/high-scale.
- El contenido se preparó desde `final/cv-send-es.md`; `final/cv-print-es.html` se exportó a PDF para el envío.
