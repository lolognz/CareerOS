...
|---|---|
| id | `project:deos` |
| name | DEOS — Data Extraction and Organization System |
| type | Proyecto personal de software y organización de conocimiento |
...
La entrevista describe la finalidad y el flujo general, pero no permite afirmar que sea un producto terminado o usado en producción.
